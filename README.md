...
This is the VB.NET version. We also offer a [C# version](https://github.com/AtalaSupport/DemoGallery_Desktop_CustomCommandDemo_CS_x64).
...
```bash
git clone https://github.com/AtalaSupport/DemoGallery_Desktop_CustomCommandDemo_VB_x64.git CustomCommandDemo --recursive
